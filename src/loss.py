...
class LossComputer:
    ...
    def manual_update(self, group_loss):
    ...
    def update_exp_avg_loss(self, group_loss, group_count):
        ...
        self.exp_avg_loss = (self.exp_avg_loss * prev_weights + group_loss*curr_weights).detach()
    ...
    def update_stats(self, actual_loss, group_loss, group_acc, group_count, weights=None):
        ...
        self.avg_group_loss = (prev_weight*self.avg_group_loss + curr_weight*group_loss).detach()
