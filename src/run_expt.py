...
def main():
    ...
    parser.add_argument('--partitioner', default=False, action='store_true')
    ...
    parser.add_argument('--train_epoch_size', type=int, default=0)
    parser.add_argument('--small_val_epoch_size', type=int, default=0)
    ...
    train_loader = train_data.get_loader(train=True, reweight_groups=args.reweight_groups, partitioner=args.partitioner, epoch_size=args.train_epoch_size, replacement=not args.partitioner, **loader_kwargs)
    val_loader = val_data.get_loader(train=False, reweight_groups=None, **loader_kwargs)
    val_loader_small = val_data.get_loader(train=True, reweight_groups=True, partitioner=args.partitioner, epoch_size=args.small_val_epoch_size, replacement=not args.partitioner, **loader_kwargs)
    ...
    data['val_loader_small'] = val_loader_small
